...
# Model preparation
PATH_TO_FROZEN_GRAPH = r'D:\Work\Sci-hub_scrapper\Python\02_CAPTCHA model training\CAPTCHA_inference_graph_noisedremoved\frozen_inference_graph.pb'
# List of the strings that is used to add correct label for each box.
PATH_TO_LABELS = r'D:\Work\Sci-hub_scrapper\Python\02_CAPTCHA model training\CAPTCHA_detection\CAPTCHA_labelmap.pbtxt'
NUM_CLASSES = 26
